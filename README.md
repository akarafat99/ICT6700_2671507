...
## Assignment Task 1
- Source file: [Coding Task 1](Coding%20Tasks/Assignments_Task_1.ipynb)
- Run in Google Colab: https://colab.research.google.com/drive/1qEqWjRL1FlomkC5CS-2aGy5lv5zy8y8D?usp=sharing

- Overview
    - **Dataset**: This project uses the Kaggle Lung Cancer Dataset (akashnath29/lung-cancer-dataset) to predict whether a patient has lung cancer based on
